...
void dht11_read_val()
{
  ...
  if((j>=40)&&(dht11_val[4] == ((dht11_val[0] + dht11_val[1] + dht11_val[2] + dht11_val[3]) & 0xFF))) {	 
      ...
      pubmsg.qos = 0;
      pubmsg.retained = 0;
      MQTTClient_publishMessage(client, "Arise/C/h2", &pubmsg, &token);
  }
}
...
int main(void) {
	...
	int rc = MQTTClient_create(&client, "ws://broker.hivemq.com:8000", "areaC_temp2", MQTTCLIENT_PERSISTENCE_NONE, NULL);
